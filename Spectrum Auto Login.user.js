...
(function() {
    ...
    if (match("https://casv.um.edu.my/cas/loginAllType?service=https://spectrum.um.edu.my/login/index.php")){
        ...
        if (!document.querySelector("div[class='error']")){
            location.href="https://casv.um.edu.my/cas/loginAllType?service=https%3A%2F%2Fspectrum.um.edu.my%2Flogin%2Findex.php";
        }
    };
    if(match("https://casv.um.edu.my/cas/loginAllType?service=https%3A%2F%2Fspectrum.um.edu.my%2Flogin%2Findex.php")){
